...
require (
	...
	github.com/vulcanize/ipld-eth-server/v4 v4.1.2-alpha
)
...
require (
	...
	github.com/vulcanize/eth-ipfs-state-validator/v4 v4.0.4-alpha // indirect
	github.com/vulcanize/ipfs-ethdb/v3 v3.0.3 // indirect
